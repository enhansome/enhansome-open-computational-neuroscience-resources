...
* [Pynapple - "PYthon Neural Analysis Package" for neurophysiological data analysis](https://github.com/pynapple-org/pynapple) ⭐ 376 | 🐛 51 | 🌐 Python | 📅 2026-08-12
...
* [DeepLabCut - Markerless pose estimation for quantifying behavior and movement kinematics in neuroscience experiments, using transfer learning from ImageNet-pretrained networks](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,735 | 🐛 41 | 🌐 Python | 📅 2026-08-12
...
* [BindsNET - Simulation of spiking neural networks (SNNs) using PyTorch](https://github.com/Hananel-Hazan/bindsnet) ⭐ 1,691 | 🐛 15 | 🌐 Python | 📅 2026-08-09
* [Jaxley - Differentiable neuron simulations on CPU, GPU, or TPU. Next-generation biophysical neuron simulator built on the JAX library.](https://github.com/jaxleyverse/jaxley) ⭐ 207 | 🐛 82 | 🌐 Python | 📅 2026-07-31
