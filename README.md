...
* Calcium Imaging (and other 3D microscopic time-series imaging)
  ...
  * [suite2p - Fast, scalable calcium imaging pipeline for cell detection (ROI extraction), neuropil correction, signal extraction, and spike deconvolution from two-photon microscopy data](https://github.com/MouseLand/suite2p) ⭐ 472 | 🐛 64 | 🌐 Python | 📅 2026-09-07
...
* [DeepLabCut - Markerless pose estimation for quantifying behavior and movement kinematics in neuroscience experiments, using transfer learning from ImageNet-pretrained networks](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,760 | 🐛 41 | 🌐 Python | 📅 2026-09-08
...
* [BindsNET - Simulation of spiking neural networks (SNNs) using PyTorch](https://github.com/Hananel-Hazan/bindsnet) ⭐ 1,697 | 🐛 8 | 🌐 Python | 📅 2026-09-07
