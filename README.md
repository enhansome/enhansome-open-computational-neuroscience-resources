# Awesome Open Computational Neuroscience Resources with stars
...
* [Pynapple - "PYthon Neural Analysis Package" for neurophysiological data analysis](https://github.com/pynapple-org/pynapple) ⭐ 379 | 🐛 57 | 🌐 Python | 📅 2026-09-04
...
* [(deprecated) OpenElectrophy - Analysis software for electrophysiological data, built on Neo](http://neuralensemble.org/OpenElectrophy/)
  * [OpenElectrophy's README](https://github.com/OpenElectrophy/OpenElectrophy) ⭐ 34 | 🐛 13 | 🌐 Python | 📅 2018-07-25 indicates that it is effectively abandoned, and you should use something else.
...
* Spike Sorting:
  * [Kilosort - GPU-accelerated spike sorting for large-scale extracellular recordings, widely used with Neuropixels probes](https://github.com/MouseLand/Kilosort) ⭐ 625 | 🐛 20 | 🌐 Python | 📅 2026-04-27
...
* Calcium Imaging (and other 3D microscopic time-series imaging)
  * [CaImAn - Calcium Imaging Analysis](https://github.com/flatironinstitute/CaImAn) ⭐ 734 | 🐛 100 | 🌐 Python | 📅 2026-08-02
  * [suite2p - Fast, scalable calcium imaging pipeline for cell detection (ROI extraction), neuropil correction, signal extraction, and spike deconvolution from two-photon microscopy data](https://github.com/MouseLand/suite2p) ⭐ 471 | 🐛 64 | 🌐 Python | 📅 2026-08-23
...
* [DeepLabCut - Markerless pose estimation for quantifying behavior and movement kinematics in neuroscience experiments, using transfer learning from ImageNet-pretrained networks](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,759 | 🐛 43 | 🌐 Python | 📅 2026-09-04
...
* [BindsNET - Simulation of spiking neural networks (SNNs) using PyTorch](https://github.com/Hananel-Hazan/bindsnet) ⭐ 1,696 | 🐛 17 | 🌐 Python | 📅 2026-09-02
* [Jaxley - Differentiable neuron simulations on CPU, GPU, or TPU. Next-generation biophysical neuron simulator built on the JAX library.](https://github.com/jaxleyverse/jaxley) ⭐ 212 | 🐛 83 | 🌐 Python | 📅 2026-09-03
* [sPyNNaker - A software package for running PyNN simulations on the SpiNNaker million core neuromorphic machine](https://github.com/SpiNNakerManchester/sPyNNaker) ⭐ 120 | 🐛 103 | 🌐 Python | 📅 2026-09-04
...
* [NEURON - The most popular computational neuroscience model simulator, focusing on biophysical modelling](https://nrn.readthedocs.io/)
  * [CoreNeuron - Optimized, simplified NEURON implementation used by the Blue Brain Project. Previously, this was a separate extension, but has now been integrated into standard NEURON](https://github.com/BlueBrain/CoreNeuron) ⚠️ Archived
...
* [BluePyOpt - Blue Brain Python Optimisation Library, for optimizing parameters in neural models](https://github.com/BlueBrain/BluePyOpt) ⚠️ Archived
* [NSDF - Neuroscience Simulation Data Format, built on HDF5](https://github.com/nsdf/nsdf) ⭐ 7 | 🐛 3 | 🌐 Python | 📅 2024-11-04
* [GIMBL-Vis - Multi-dimensional visualization toolbox; integrates with DynaSim](https://github.com/erik-roberts/GIMBL-Vis) ⭐ 4 | 🐛 1 | 🌐 MATLAB | 📅 2020-08-21
* [BRAHMS - A modular execution framework for executing integrated systems built from component software processes](https://github.com/BRAHMS-SystemML/brahms) ⭐ 3 | 🐛 5 | 🌐 C++ | 📅 2019-04-30
...
* [Neurodata Without Borders: Neurophysiology (NWB:N) data standard for
  ...
  * [ndx-simulation-output Large-scale simulation data scheme extenstion to
    NWB:N](https://github.com/catalystneuro/ndx-simulation-output) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2020-11-12
